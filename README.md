...
To be consistent with the structure of the <a href="https://pfitsplus.github.io/assets/docs/research/code-comparisons/si/sicc_problem_set.pdf" target="_blank">Problem Set</a> (Section 1.2), the subdirectories are hierarchically organized first by *model* (e.g., [`/unstratified`](https://github.com/pfitsplus/sicc/tree/main/unstratified)), next by *problem* (e.g., [`../BA`](https://github.com/pfitsplus/sicc/tree/main/unstratified/BA)), and last by *variation* (e.g., [`../../512`](https://github.com/pfitsplus/sicc/tree/main/unstratified/BA/512)).
